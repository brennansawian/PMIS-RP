    ...
    a.directive("fusioncharts",["$http",function(a){
        return{
            ...
            link:function(a,b,c){
                    ...
                    NDCObserver:{
                        ...
                        config:{
                            ...
                            observer:function(a){
                                ...
                                if(a){
                                    b=JSON.parse(a);
                                    for(c in b)j[c]!=b[c]&&(d=!0,j[c]=b[c]);d&&u()
                                }
                            }
                        }
                    },
                ...
                for(i in o.NDCObserver)attrConfig=o.NDCObserver[i],(attrConfig.ifExist===!1||c[i])&&c.$observe(i,attrConfig.observer);c.datasource&&(j.dataSource="json"===j.dataFormat?JSON.parse(c.datasource):c.datasource,v.dataSource=c.datasource);
                for(i in o.DCObserver)attrConfig=o.DCObserver[i],l=c[i],l?(c.$observe(i,attrConfig.observer),v[i]=l,"json"===j.dataFormat&&"object"==typeof j.dataSource&&(j.dataSource[i]=JSON.parse(l))):attrConfig.ifExist===!1&&c.$observe(i,attrConfig.observer);if(c.config){
